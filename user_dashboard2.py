...
##    h = filename.image2.height()
    ...
    Label(screen4, text="BOT", bg="Gray", height=2, width=250,font=("Arial Bold", 24)).pack()

    tool_bar = Frame(width=50, height=150, bg='lightgrey')
    tool_bar.pack(side='left', fill='both', padx=1, pady=1, expand=True)
 
    filter_bar = Frame(width=50, height=150, bg='lightgrey')
    ...
    background_label = Label(screen4)
    C.pack()
    ...
    b13= Button(screen4, text="Line Follow",height=2,width=50,bg="black",fg="yellow",font=("Arial Bold", 15),command=line_follow)
