...
def view_relatives():
    ...
    window.title("View Face Record")
    image2 =Image.open('E:/BE SEM VIII/BE Project/BOT/grayscale.jpg')
    image1 = ImageTk.PhotoImage(image2)
    w = image1.width()
    h = image1.height()
    window.geometry('%dx%d+0+0' % (w,h))
    filename =ImageTk.PhotoImage(Image.open('E:/BE SEM VIII/BE Project/BOT/grayscale.jpg'))

    Label(window, text="Face Details", bg="Grey", height=1, width=250,font=("Arial Bold", 20), command = conn4()).pack()
    ...
    tree["column"] = ("Face Name", "Relation", "Mobile")
    
    tree.column("Face Name", width=150)
    tree.heading("face Name", text="face Name")
