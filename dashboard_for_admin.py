...
def main_screen():
    ...
    background_label = Label(screen3)
   ...
   # filename.image2 =ImageTk.PhotoImage(Image.open('186040.gif'))
    ...
    Label(screen3, text="BOT", bg="white", height=2, width=250,font=("Arial Bold", 24)).pack()
    ...
    b5 =  Button(tool_bar,text="Add Face Record",height=2,width=50,bg="black",fg="blue",font=("Arial Bold", 15),command=attend)
    ...
    #Label(screen3, text="", bg="white").pack()
    b7= Button(tool_bar, text="View Face Record",height=2,width=50,bg="black",fg="yellow",font=("Arial Bold", 15),command=view_attendance)
...
def open_voice():
    ...
    frame2 = PhotoImage(file="./image.gif", format="gif -index 2")    
...
def attend():
    ...
    Label(screen3, text="Face Records", font=("Arial Bold", 25),bg="grey",width=250,height=2).pack()
    Label(screen3, text="", bg="white").pack()
    Label(screen3, text="", bg="white").pack()
...
def record_faces():
    ...
    print(a)
    path1 = 'E:/BE SEM VIII/BE Project/BOT/dataset'
    model_detector='E:/BE SEM VIII/BE Project/BOT/opencv_face_detector.pbtxt'
    ...
    if not os.path.exists('./dataset'):
        os.makedirs('./dataset')
#c = conn.cursor()
    face_cascade = cv2.CascadeClassifier('E:/BE SEM VIII/BE Project/BOT/haar.xml')
